...
| Название проекта | Описание | Стек |
| :--- | --- | :--- |
| [Предсказания оттока клиентов](https://github.com/Vyshegorodtsev21/Practicum/tree/main/2024-customer-churn-predicting) |
Разработка модели прогнозирования оттока клиентов для оператора связи на основе персональных данных клиентов, информации о их тарифах и использованных услугах. | Jupyter Notebook, Python - *pandas, numpy, seaborn, sklearn, matplotlib, phik, ydata_profiling, catboost* |
